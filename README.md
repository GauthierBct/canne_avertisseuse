### Notes
note de cette version : 03/07/2020


### Reste à faire : 
- comment savoir si la canne est toujours connectée au réseau ? (verifier si c'est le cas ou non est mettre a jour l'etat de la led "lora")
